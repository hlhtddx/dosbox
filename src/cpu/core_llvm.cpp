...
Bit32u CpuRunnerLLVMBase::SIBZero = 0;
Bit32u * CpuRunnerLLVMBase::SIBIndex[8] = { &reg_eax,&reg_ecx,&reg_edx,&reg_ebx,&CpuRunnerLLVMBase::SIBZero,&reg_ebp,&reg_esi,&reg_edi };
...
Bits CPU_Core_LLVM_Run() {
	while (CPU_Cycles-- > 0) {
        ...
        llvm_runner.m_nReturnVal = CBRET_NONE;
