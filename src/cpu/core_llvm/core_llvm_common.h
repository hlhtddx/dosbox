...
template <typename operand_type> operand_type WriteMemory(PhysPt address, operand_type value);
...
public:
    ...
    template<typename data_type> data_type GetAbsoluteAddress() {
        data_type address = GetImmediateNumber<data_type>();
        //
    }

    template<typename data_type> data_type GetRelativeAddress() {
        data_type address = GetImmediateNumber<data_type>();
        //
    }
