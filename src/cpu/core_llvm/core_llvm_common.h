...
protected:
    template<typename data_type> inline bool Do_ROL(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_ROR(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_RCL(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_RCR(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_SHL(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_SHR(GeneralReference<data_type> *destination, data_type source);
    template<typename data_type> inline bool Do_SAR(GeneralReference<data_type> *destination, data_type source);
...
template<> inline bool CpuRunnerLLVMBase::Do_ROL<Bit8u>(GeneralReference<Bit8u> *destination, Bit8u source) {
    ...
    if (!(source & 0x7)) {
        if (source & 0x18) {
            FillFlagsNoCFOF();
            SETFLAGBIT(CF, lf_var1b & 1);
            SETFLAGBIT(OF, (lf_var1b & 1) ^ (lf_var1b >> 7));
        }
        return true;
    }
    FillFlagsNoCFOF();
...
template<> inline bool CpuRunnerLLVMBase::Do_ROL<Bit16u>(GeneralReference<Bit16u> *destination, Bit16u source) {
    lf_var1w = destination->Read();
    if (!(source & 0xf)) {
        if (source & 0x10) {
            FillFlagsNoCFOF();
            SETFLAGBIT(CF, lf_var1w & 1);
            SETFLAGBIT(OF, (lf_var1w & 1) ^ (lf_var1w >> 15));
        }
        return true;
    }
    FillFlagsNoCFOF();
...
template<> inline bool CpuRunnerLLVMBase::Do_ROL<Bit32u>(GeneralReference<Bit32u> *destination, Bit32u source) {
...
template<> inline bool CpuRunnerLLVMBase::Do_ROR(GeneralReference<Bit8u> *destination, Bit8u source) {
    ...
    if (!(source & 0x7)) {
        if (source & 0x18) {
            FillFlagsNoCFOF();
            SETFLAGBIT(CF, lf_var1b >> 7);
            SETFLAGBIT(OF, (lf_var1b >> 7) ^ ((lf_var1b >> 6) & 1));
        }
        return true;
    }
    FillFlagsNoCFOF();
...
template<> inline bool CpuRunnerLLVMBase::Do_ROR(GeneralReference<Bit16u> *destination, Bit16u source) {
    lf_var1w = destination->Read();
    if (!(source & 0xf)) {
        if (source & 0x10) {
            FillFlagsNoCFOF();
            SETFLAGBIT(CF, lf_var1w >> 15);
            SETFLAGBIT(OF, (lf_var1w >> 15) ^ ((lf_var1w >> 14) & 1));
        }
        return true;
    }
    FillFlagsNoCFOF();
...
template<> inline bool CpuRunnerLLVMBase::Do_ROR(GeneralReference<Bit32u> *destination, Bit32u source) {
    lf_var1d = destination->Read();
    if (!source) {
        return true;
    }
...
template<> inline bool CpuRunnerLLVMBase::Do_RCL(GeneralReference<Bit16u> *destination, Bit16u source) {
...
template<> inline bool CpuRunnerLLVMBase::Do_RCL(GeneralReference<Bit32u> *destination, Bit32u source) {
...
template<> inline bool CpuRunnerLLVMBase::Do_RCR(GeneralReference<Bit16u> *destination, Bit16u source) {
    if (source % 17) {
        auto cf = (Bit16u) (FillFlags() & 0x1);
        lf_var1w = destination->Read();
        lf_var2b = source % 17;
...
template<> inline bool CpuRunnerLLVMBase::Do_RCR(GeneralReference<Bit32u> *destination, Bit32u source) {
    if (source) {
        auto cf = (Bit32u) (FillFlags() & 0x1);
        lf_var1w = destination->Read();
        lf_var2b = source;
...
template<> inline bool CpuRunnerLLVMBase::Do_SHL(GeneralReference<Bit16u> *destination, Bit16u source) {
    if (source) {
        lf_var1w = destination->Read();
        lf_var2b = source;
        lf_resw = lf_var1w << lf_var2b;
...
template<> inline bool CpuRunnerLLVMBase::Do_SHL(GeneralReference<Bit32u> *destination, Bit32u source) {
    if (source) {
        lf_var1d = destination->Read();
        lf_var2b = source;
        lf_resd = lf_var1d << lf_var2b;
...
template<> inline bool CpuRunnerLLVMBase::Do_SHR(GeneralReference<Bit16u> *destination, Bit16u source) {
    if (source) {
        lf_var1w = destination->Read();
        lf_var2b = source;
        lf_resw = lf_var1w >> lf_var2b;
...
template<> inline bool CpuRunnerLLVMBase::Do_SHR(GeneralReference<Bit32u> *destination, Bit32u source) {
    if (source) {
        lf_var1d = destination->Read();
        lf_var2b = source;
        lf_resd = lf_var1d >> lf_var2b;
...
template<> inline bool CpuRunnerLLVMBase::Do_SAR(GeneralReference<Bit16u> *destination, Bit16u source) {
    if (source) {
        lf_var1w = destination->Read();
        lf_var2b = source;
...
template<> inline bool CpuRunnerLLVMBase::Do_SAR(GeneralReference<Bit32u> *destination, Bit32u source) {
    if (source) {
        lf_var1d = destination->Read();
        lf_var2b = source;
        if (lf_var1d & 0x80000000) {
            lf_resd = (lf_var1d >> lf_var2b) |
                (0x80000000 << (32 - lf_var2b));
        } else {
            lf_resd = lf_var1d >> lf_var2b;
        }
        destination->Write(lf_resd);
