...
inline bool CpuRunnerLLVM::handler_in_98_CBW_CWDE() {
    if (Is32BitOperandMode()) {
        reg_eax = static_cast<Bit16s>(reg_ax);
    } else {
        reg_ax = static_cast<Bit16s>(reg_al);
    }
    return true;
}
...
inline bool CpuRunnerLLVM::handler_st_F6() {
    ...
    switch (rm) {
        case 0x01:return handler_in_F6_01_TEST_Ib(rmmod);
        case 0x02:return handler_in_F6_02_NOT_Eb(rmmod);
        case 0x03:return handler_in_F6_03_NEG_Eb(rmmod);
        case 0x04:return handler_in_F6_04_MUL_Eb(rmmod);
        case 0x05:return handler_in_F6_05_IMUL_Eb(rmmod);
        case 0x06:return handler_in_F6_06_DIV_Eb(rmmod);
        case 0x07:return handler_in_F6_07_IDIV_Eb(rmmod);
...
inline bool CpuRunnerLLVM::handler_st_F7() {
    ...
    switch (rm) {
        case 0x01:return handler_in_F7_01_TEST_Ivqp(rmmod);
        case 0x02:return handler_in_F7_02_NOT_Evqp(rmmod);
        case 0x03:return handler_in_F7_03_NEG_Evqp(rmmod);
        case 0x04:return handler_in_F7_04_MUL_Evqp(rmmod);
        case 0x05:return handler_in_F7_05_IMUL_Evqp(rmmod);
        case 0x06:return handler_in_F7_06_DIV_Evqp(rmmod);
        case 0x07:return handler_in_F7_07_IDIV_Evqp(rmmod);
...
inline bool CpuRunnerLLVM::handler_st_FE() {
    ...
    switch (rm) {
        case 0x00:return handler_in_FE_00_INC_Eb(rmmod);
        case 0x01:return handler_in_FE_01_DEC_Eb(rmmod);
        case 0x07:return handler_in_FE_07_CALLBACK(rmmod);
...
inline bool CpuRunnerLLVM::handler_st_FF() {
    ...
    switch (rm) {
        case 0x00:return handler_in_FF_00_INC_Evqp(rmmod);
        case 0x01:return handler_in_FF_01_DEC_Evqp(rmmod);
        case 0x02:return handler_in_FF_02_CALL_Ev(rmmod);
        case 0x03:return handler_in_FF_03_CALLF_Mptp(rmmod);
        case 0x04:return handler_in_FF_04_JMP_Ev(rmmod);
        case 0x05:return handler_in_FF_05_JMPF_Mptp(rmmod);
        case 0x06:return handler_in_FF_06_PUSH_Ev(rmmod);
