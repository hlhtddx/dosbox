...
inline void Handle_ADC_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
/* _05:ADD Add */
inline void Handle_ADD_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
/* _25:AND Logical AND */
inline void Handle_AND_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_BSWAP_AX(Bit8u last, PhysPt &cseip) {
};


/* _0f_cd:BSWAP Byte Swap */
inline void Handle_BSWAP_BP(Bit8u last, PhysPt &cseip) {
};


/* _0f_cb:BSWAP Byte Swap */
inline void Handle_BSWAP_BX(Bit8u last, PhysPt &cseip) {
};


/* _0f_c9:BSWAP Byte Swap */
inline void Handle_BSWAP_CX(Bit8u last, PhysPt &cseip) {
};


/* _0f_cf:BSWAP Byte Swap */
inline void Handle_BSWAP_DI(Bit8u last, PhysPt &cseip) {
};


/* _0f_ca:BSWAP Byte Swap */
inline void Handle_BSWAP_DX(Bit8u last, PhysPt &cseip) {
};


/* _0f_ce:BSWAP Byte Swap */
inline void Handle_BSWAP_SI(Bit8u last, PhysPt &cseip) {
};


/* _0f_cc:BSWAP Byte Swap */
inline void Handle_BSWAP_SP(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_CMP_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_DEC_AX(Bit8u last, PhysPt &cseip) {
};


/* _4d:DEC Decrement by 1 */
inline void Handle_DEC_BP(Bit8u last, PhysPt &cseip) {
};


/* _4b:DEC Decrement by 1 */
inline void Handle_DEC_BX(Bit8u last, PhysPt &cseip) {
};


/* _49:DEC Decrement by 1 */
inline void Handle_DEC_CX(Bit8u last, PhysPt &cseip) {
};


/* _4f:DEC Decrement by 1 */
inline void Handle_DEC_DI(Bit8u last, PhysPt &cseip) {
};


/* _4a:DEC Decrement by 1 */
inline void Handle_DEC_DX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_DEC_SI(Bit8u last, PhysPt &cseip) {
};


/* _4c:DEC Decrement by 1 */
inline void Handle_DEC_SP(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_INC_AX(Bit8u last, PhysPt &cseip) {
};


/* _45:INC Increment by 1 */
inline void Handle_INC_BP(Bit8u last, PhysPt &cseip) {
};


/* _43:INC Increment by 1 */
inline void Handle_INC_BX(Bit8u last, PhysPt &cseip) {
};


/* _41:INC Increment by 1 */
inline void Handle_INC_CX(Bit8u last, PhysPt &cseip) {
};


/* _47:INC Increment by 1 */
inline void Handle_INC_DI(Bit8u last, PhysPt &cseip) {
};


/* _42:INC Increment by 1 */
inline void Handle_INC_DX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_INC_SI(Bit8u last, PhysPt &cseip) {
};


/* _44:INC Increment by 1 */
inline void Handle_INC_SP(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_IN_AX_DX(Bit8u last, PhysPt &cseip) {
};


/* _e5:IN Input from Port */
inline void Handle_IN_AX_Ib(Bit8u last, PhysPt &cseip) {
};
...
/* _b8:MOV Move */
inline void Handle_MOV_AX_Ivqp(Bit8u last, PhysPt &cseip) {
};


/* _a1:MOV Move */
inline void Handle_MOV_AX_Ovqp(Bit8u last, PhysPt &cseip) {
};
...
/* _bd:MOV Move */
inline void Handle_MOV_BP_Ivqp(Bit8u last, PhysPt &cseip) {
};


/* _bb:MOV Move */
inline void Handle_MOV_BX_Ivqp(Bit8u last, PhysPt &cseip) {
};
...
/* _b9:MOV Move */
inline void Handle_MOV_CX_Ivqp(Bit8u last, PhysPt &cseip) {
};
...
/* _bf:MOV Move */
inline void Handle_MOV_DI_Ivqp(Bit8u last, PhysPt &cseip) {
};
...
/* _ba:MOV Move */
inline void Handle_MOV_DX_Ivqp(Bit8u last, PhysPt &cseip) {
};
...
/* _a3:MOV Move */
inline void Handle_MOV_Ovqp_AX(Bit8u last, PhysPt &cseip) {
};


/* _be:MOV Move */
inline void Handle_MOV_SI_Ivqp(Bit8u last, PhysPt &cseip) {
};


/* _bc:MOV Move */
inline void Handle_MOV_SP_Ivqp(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_OR_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_OUT_DX_AX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_OUT_Ib_AX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_POP_AX(Bit8u last, PhysPt &cseip) {
};


/* _5d:POP Pop a Value from the Stack */
inline void Handle_POP_BP(Bit8u last, PhysPt &cseip) {
};


/* _5b:POP Pop a Value from the Stack */
inline void Handle_POP_BX(Bit8u last, PhysPt &cseip) {
};


/* _59:POP Pop a Value from the Stack */
inline void Handle_POP_CX(Bit8u last, PhysPt &cseip) {
};


/* _5f:POP Pop a Value from the Stack */
inline void Handle_POP_DI(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_POP_DX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_POP_SI(Bit8u last, PhysPt &cseip) {
};


/* _5c:POP Pop a Value from the Stack */
inline void Handle_POP_SP(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_PUSH_AX(Bit8u last, PhysPt &cseip) {
};


/* _55:PUSH Push Word, Doubleword or Quadword Onto the Stack */
inline void Handle_PUSH_BP(Bit8u last, PhysPt &cseip) {
};


/* _53:PUSH Push Word, Doubleword or Quadword Onto the Stack */
inline void Handle_PUSH_BX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_PUSH_CX(Bit8u last, PhysPt &cseip) {
};


/* _57:PUSH Push Word, Doubleword or Quadword Onto the Stack */
inline void Handle_PUSH_DI(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_PUSH_DX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_PUSH_SI(Bit8u last, PhysPt &cseip) {
};


/* _54:PUSH Push Word, Doubleword or Quadword Onto the Stack */
inline void Handle_PUSH_SP(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_SBB_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
/* _2d:SUB Subtract */
inline void Handle_SUB_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_TEST_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_XCHG_acc_AX_AX(Bit8u last, PhysPt &cseip) {
};


/* _95:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_BP_AX(Bit8u last, PhysPt &cseip) {
};


/* _93:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_BX_AX(Bit8u last, PhysPt &cseip) {
};


/* _91:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_CX_AX(Bit8u last, PhysPt &cseip) {
};


/* _97:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_DI_AX(Bit8u last, PhysPt &cseip) {
};


/* _92:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_DX_AX(Bit8u last, PhysPt &cseip) {
};


/* _96:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_SI_AX(Bit8u last, PhysPt &cseip) {
};


/* _94:XCHG Exchange Register/Memory with Register */
inline void Handle_XCHG_acc_SP_AX(Bit8u last, PhysPt &cseip) {
};
...
inline void Handle_XOR_acc_AX_Ivds(Bit8u last, PhysPt &cseip) {
};
...
const OpState CpuRunnerX86::table[] = {
	// 00
	I_ADD_Eb_Gb, I_ADD_Evqp_Gvqp, I_ADD_Gb_Eb, I_ADD_Gvqp_Evqp, I_ADD_acc_AL_Ib, I_ADD_acc_AX_Ivds, I_PUSH_ES, I_POP_ES, 
	// 08
	I_OR_Eb_Gb, I_OR_Evqp_Gvqp, I_OR_Gb_Eb, I_OR_Gvqp_Evqp, I_OR_acc_AL_Ib, I_OR_acc_AX_Ivds, I_PUSH_CS, ST_0f, 
	// 10
	I_ADC_Eb_Gb, I_ADC_Evqp_Gvqp, I_ADC_Gb_Eb, I_ADC_Gvqp_Evqp, I_ADC_acc_AL_Ib, I_ADC_acc_AX_Ivds, I_PUSH_SS, I_POP_delaysint_SS, 
	// 18
	I_SBB_Eb_Gb, I_SBB_Evqp_Gvqp, I_SBB_Gb_Eb, I_SBB_Gvqp_Evqp, I_SBB_acc_AL_Ib, I_SBB_acc_AX_Ivds, I_PUSH_DS, I_POP_DS, 
	// 20
	I_AND_Eb_Gb, I_AND_Evqp_Gvqp, I_AND_Gb_Eb, I_AND_Gvqp_Evqp, I_AND_acc_AL_Ib, I_AND_acc_AX_Ivds, PR_26, I_DAA, 
	// 28
	I_SUB_Eb_Gb, I_SUB_Evqp_Gvqp, I_SUB_Gb_Eb, I_SUB_Gvqp_Evqp, I_SUB_acc_AL_Ib, I_SUB_acc_AX_Ivds, PR_2e, I_DAS, 
	// 30
	I_XOR_Eb_Gb, I_XOR_Evqp_Gvqp, I_XOR_Gb_Eb, I_XOR_Gvqp_Evqp, I_XOR_acc_AL_Ib, I_XOR_acc_AX_Ivds, PR_36, I_AAA, 
	// 38
	I_CMP_Eb_Gb, I_CMP_Evqp_Gvqp, I_CMP_Gb_Eb, I_CMP_Gvqp_Evqp, I_CMP_acc_AL_Ib, I_CMP_acc_AX_Ivds, PR_3e, I_AAS, 
	// 40
	I_INC_AX, I_INC_CX, I_INC_DX, I_INC_BX, I_INC_SP, I_INC_BP, I_INC_SI, I_INC_DI, 
	// 48
	I_DEC_AX, I_DEC_CX, I_DEC_DX, I_DEC_BX, I_DEC_SP, I_DEC_BP, I_DEC_SI, I_DEC_DI, 
	// 50
	I_PUSH_AX, I_PUSH_CX, I_PUSH_DX, I_PUSH_BX, I_PUSH_SP, I_PUSH_BP, I_PUSH_SI, I_PUSH_DI, 
	// 58
	I_POP_AX, I_POP_CX, I_POP_DX, I_POP_BX, I_POP_SP, I_POP_BP, I_POP_SI, I_POP_DI, 
	// 60
	I_PUSHA, I_POPA, I_BOUND_Gv_Ma, I_ARPL_Ew_Gw, PR_64, PR_65, ST_66, I_ILLEGAL, 
	// 68
	...
	// 90
	I_XCHG_acc_AX_AX, I_XCHG_acc_CX_AX, I_XCHG_acc_DX_AX, I_XCHG_acc_BX_AX, I_XCHG_acc_SP_AX, I_XCHG_acc_BP_AX, I_XCHG_acc_SI_AX, I_XCHG_acc_DI_AX, 
	// 98
	I_CBW, I_CWD, I_CALLF_Ap, I_FWAIT, I_PUSHF, I_POPF, I_SAHF, I_LAHF, 
	// A0
	I_MOV_AL_Ob, I_MOV_AX_Ovqp, I_MOV_Ob_AL, I_MOV_Ovqp_AX, I_MOVS_Yb_Xb, I_MOVS_Yw_Xw, I_CMPS_Yb_Xb, I_CMPS_Yw_Xw, 
	// A8
	I_TEST_acc_AL_Ib, I_TEST_acc_AX_Ivds, I_STOS_Yb, I_STOS_Yw, I_LODS_Xb, I_LODS_Xw, I_SCAS_Yb, I_SCAS_Yw, 
	// B0
	I_MOV_AL_Ib, I_MOV_CL_Ib, I_MOV_DL_Ib, I_MOV_BL_Ib, I_MOV_AH_Ib, I_MOV_CH_Ib, I_MOV_DH_Ib, I_MOV_BH_Ib, 
	// B8
	I_MOV_AX_Ivqp, I_MOV_CX_Ivqp, I_MOV_DX_Ivqp, I_MOV_BX_Ivqp, I_MOV_SP_Ivqp, I_MOV_BP_Ivqp, I_MOV_SI_Ivqp, I_MOV_DI_Ivqp, 
	// C0
	...
	// E0
	I_LOOPNZ_Jbs, I_LOOPZ_Jbs, I_LOOP_Jbs, I_JCXZ_Jbs, I_IN_AL_Ib, I_IN_AX_Ib, I_OUT_Ib_AL, I_OUT_Ib_AX, 
	// E8
	I_CALL_Jvds, I_JMP_Jvds, I_JMPF_Ap, I_JMP_Jbs, I_IN_AL_DX, I_IN_AX_DX, I_OUT_DX_AL, I_OUT_DX_AX, 
	// F0
...
const OpState CpuRunnerX86::table_0f[] = {
	...
	// C8
	I_BSWAP_AX, I_BSWAP_CX, I_BSWAP_DX, I_BSWAP_BX, I_BSWAP_SP, I_BSWAP_BP, I_BSWAP_SI, I_BSWAP_DI, 
	// D0
...
const OpState CpuRunnerX86::table_66[] = {
	...
	I_ADD_Eb_Gb, I_ADD_Evqp_Gvqp, I_ADD_Gb_Eb, I_ADD_Gvqp_Evqp, I_ADD_acc_AL_Ib, I_ADD_acc_AX_Ivds, I_PUSH_ES, I_POP_ES, 
	// 08
	I_OR_Eb_Gb, I_OR_Evqp_Gvqp, I_OR_Gb_Eb, I_OR_Gvqp_Evqp, I_OR_acc_AL_Ib, I_OR_acc_AX_Ivds, I_PUSH_CS, ST_66_0f, 
	// 10
	I_ADC_Eb_Gb, I_ADC_Evqp_Gvqp, I_ADC_Gb_Eb, I_ADC_Gvqp_Evqp, I_ADC_acc_AL_Ib, I_ADC_acc_AX_Ivds, I_PUSH_SS, I_POP_delaysint_SS, 
	// 18
	I_SBB_Eb_Gb, I_SBB_Evqp_Gvqp, I_SBB_Gb_Eb, I_SBB_Gvqp_Evqp, I_SBB_acc_AL_Ib, I_SBB_acc_AX_Ivds, I_PUSH_DS, I_POP_DS, 
	...
	I_POP_AX, I_POP_CX, I_POP_DX, I_POP_BX, I_POP_SP, I_POP_BP, I_POP_SI, I_POP_DI, 
	// 60
	I_PUSHA, I_POPA, I_BOUND_Gv_Ma, I_ARPL_Ew_Gw, PR_64, PR_65, I_ILLEGAL, I_ILLEGAL, 
	// 68
	I_PUSH_Ivs, I_IMUL_Gvqp_Evqp_Ivds, I_PUSH_Ibss, I_IMUL_Gvqp_Evqp_Ibs, I_INS_Yb_DX, I_INS_Yw_DX, I_OUTS_DX_Xb, I_OUTS_DX_Xw, 
	// 70
	I_JO_Jbs, I_JNO_Jbs, I_JB_Jbs, I_JNB_Jbs, I_JZ_Jbs, I_JNZ_Jbs, I_JBE_Jbs, I_JNBE_Jbs, 
...
const OpState CpuRunnerX86::table_f2[] = {
	...
	I_ADD_Eb_Gb, I_ADD_Evqp_Gvqp, I_ADD_Gb_Eb, I_ADD_Gvqp_Evqp, I_ADD_acc_AL_Ib, I_ADD_acc_AX_Ivds, I_PUSH_ES, I_POP_ES, 
	// 08
	I_OR_Eb_Gb, I_OR_Evqp_Gvqp, I_OR_Gb_Eb, I_OR_Gvqp_Evqp, I_OR_acc_AL_Ib, I_OR_acc_AX_Ivds, I_PUSH_CS, ST_f2_0f, 
	// 10
	I_ADC_Eb_Gb, I_ADC_Evqp_Gvqp, I_ADC_Gb_Eb, I_ADC_Gvqp_Evqp, I_ADC_acc_AL_Ib, I_ADC_acc_AX_Ivds, I_PUSH_SS, I_POP_delaysint_SS, 
	// 18
	I_SBB_Eb_Gb, I_SBB_Evqp_Gvqp, I_SBB_Gb_Eb, I_SBB_Gvqp_Evqp, I_SBB_acc_AL_Ib, I_SBB_acc_AX_Ivds, I_PUSH_DS, I_POP_DS, 
...
const OpState CpuRunnerX86::table_f3[] = {
	...
	I_ADD_Eb_Gb, I_ADD_Evqp_Gvqp, I_ADD_Gb_Eb, I_ADD_Gvqp_Evqp, I_ADD_acc_AL_Ib, I_ADD_acc_AX_Ivds, I_PUSH_ES, I_POP_ES, 
	// 08
	I_OR_Eb_Gb, I_OR_Evqp_Gvqp, I_OR_Gb_Eb, I_OR_Gvqp_Evqp, I_OR_acc_AL_Ib, I_OR_acc_AX_Ivds, I_PUSH_CS, ST_f3_0f, 
	// 10
	I_ADC_Eb_Gb, I_ADC_Evqp_Gvqp, I_ADC_Gb_Eb, I_ADC_Gvqp_Evqp, I_ADC_acc_AL_Ib, I_ADC_acc_AX_Ivds, I_PUSH_SS, I_POP_delaysint_SS, 
	// 18
	I_SBB_Eb_Gb, I_SBB_Evqp_Gvqp, I_SBB_Gb_Eb, I_SBB_Gvqp_Evqp, I_SBB_acc_AL_Ib, I_SBB_acc_AX_Ivds, I_PUSH_DS, I_POP_DS, 
	...
	I_MOV_Eb_Gb, I_MOV_Evqp_Gvqp, I_MOV_Gb_Eb, I_MOV_Gvqp_Evqp, I_MOV_Mw_Sw, I_LEA_Gvqp_M, I_MOV_Sw_Ew, ST_8f, 
	// 90
	I_NOP_nop, I_XCHG_acc_CX_AX, I_XCHG_acc_DX_AX, I_XCHG_acc_BX_AX, I_XCHG_acc_SP_AX, I_XCHG_acc_BP_AX, I_XCHG_acc_SI_AX, I_XCHG_acc_DI_AX, 
	// 98
	I_CBW, I_CWD, I_CALLF_Ap, I_FWAIT, I_PUSHF, I_POPF, I_SAHF, I_LAHF, 
	// A0
	I_MOV_AL_Ob, I_MOV_AX_Ovqp, I_MOV_Ob_AL, I_MOV_Ovqp_AX, I_MOVS_Yb_Xb, I_MOVS_Yw_Xw, I_CMPS_Yb_Xb, I_CMPS_Yw_Xw, 
...
bool CpuRunnerX86::Parse(PhysPt &cseip) {
    ...
    case I_ADC_acc_AX_Ivds:
        Handle_ADC_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_ADD_acc_AX_Ivds:
        Handle_ADD_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_AND_acc_AX_Ivds:
        Handle_AND_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_BSWAP_AX:
        Handle_BSWAP_AX(insb, cseip);
        break;

    case I_BSWAP_BP:
        Handle_BSWAP_BP(insb, cseip);
        break;

    case I_BSWAP_BX:
        Handle_BSWAP_BX(insb, cseip);
        break;

    case I_BSWAP_CX:
        Handle_BSWAP_CX(insb, cseip);
        break;

    case I_BSWAP_DI:
        Handle_BSWAP_DI(insb, cseip);
        break;

    case I_BSWAP_DX:
        Handle_BSWAP_DX(insb, cseip);
        break;

    case I_BSWAP_SI:
        Handle_BSWAP_SI(insb, cseip);
        break;

    case I_BSWAP_SP:
        Handle_BSWAP_SP(insb, cseip);
        break;
    ...
    case I_CMP_acc_AX_Ivds:
        Handle_CMP_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_DEC_AX:
        Handle_DEC_AX(insb, cseip);
        break;

    case I_DEC_BP:
        Handle_DEC_BP(insb, cseip);
        break;

    case I_DEC_BX:
        Handle_DEC_BX(insb, cseip);
        break;

    case I_DEC_CX:
        Handle_DEC_CX(insb, cseip);
        break;

    case I_DEC_DI:
        Handle_DEC_DI(insb, cseip);
        break;

    case I_DEC_DX:
        Handle_DEC_DX(insb, cseip);
        break;
    ...
    case I_DEC_SI:
        Handle_DEC_SI(insb, cseip);
        break;

    case I_DEC_SP:
        Handle_DEC_SP(insb, cseip);
        break;
    ...
    case I_INC_AX:
        Handle_INC_AX(insb, cseip);
        break;

    case I_INC_BP:
        Handle_INC_BP(insb, cseip);
        break;

    case I_INC_BX:
        Handle_INC_BX(insb, cseip);
        break;

    case I_INC_CX:
        Handle_INC_CX(insb, cseip);
        break;

    case I_INC_DI:
        Handle_INC_DI(insb, cseip);
        break;

    case I_INC_DX:
        Handle_INC_DX(insb, cseip);
        break;
    ...
    case I_INC_SI:
        Handle_INC_SI(insb, cseip);
        break;

    case I_INC_SP:
        Handle_INC_SP(insb, cseip);
        break;
    ...
    case I_IN_AX_DX:
        Handle_IN_AX_DX(insb, cseip);
        break;

    case I_IN_AX_Ib:
        Handle_IN_AX_Ib(insb, cseip);
        break;
    ...
    case I_MOV_AX_Ivqp:
        Handle_MOV_AX_Ivqp(insb, cseip);
        break;

    case I_MOV_AX_Ovqp:
        Handle_MOV_AX_Ovqp(insb, cseip);
        break;
    ...
    case I_MOV_BP_Ivqp:
        Handle_MOV_BP_Ivqp(insb, cseip);
        break;

    case I_MOV_BX_Ivqp:
        Handle_MOV_BX_Ivqp(insb, cseip);
        break;
    ...
    case I_MOV_Ovqp_AX:
        Handle_MOV_Ovqp_AX(insb, cseip);
        break;

    case I_MOV_SI_Ivqp:
        Handle_MOV_SI_Ivqp(insb, cseip);
        break;

    case I_MOV_SP_Ivqp:
        Handle_MOV_SP_Ivqp(insb, cseip);
        break;
    ...
    case I_OR_acc_AX_Ivds:
        Handle_OR_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_POP_AX:
        Handle_POP_AX(insb, cseip);
        break;

    case I_POP_BP:
        Handle_POP_BP(insb, cseip);
        break;

    case I_POP_BX:
        Handle_POP_BX(insb, cseip);
        break;

    case I_POP_CX:
        Handle_POP_CX(insb, cseip);
        break;

    case I_POP_DI:
        Handle_POP_DI(insb, cseip);
        break;
    ...
    case I_POP_SI:
        Handle_POP_SI(insb, cseip);
        break;

    case I_POP_SP:
        Handle_POP_SP(insb, cseip);
        break;
    ...
    case I_PUSH_AX:
        Handle_PUSH_AX(insb, cseip);
        break;

    case I_PUSH_BP:
        Handle_PUSH_BP(insb, cseip);
        break;

    case I_PUSH_BX:
        Handle_PUSH_BX(insb, cseip);
        break;
    ...
    case I_PUSH_CX:
        Handle_PUSH_CX(insb, cseip);
        break;

    case I_PUSH_DI:
        Handle_PUSH_DI(insb, cseip);
        break;
    ...
    case I_PUSH_SI:
        Handle_PUSH_SI(insb, cseip);
        break;

    case I_PUSH_SP:
        Handle_PUSH_SP(insb, cseip);
        break;
    ...
    case I_SBB_acc_AX_Ivds:
        Handle_SBB_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_SUB_acc_AX_Ivds:
        Handle_SUB_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_TEST_acc_AX_Ivds:
        Handle_TEST_acc_AX_Ivds(insb, cseip);
        break;
    ...
    case I_XCHG_acc_AX_AX:
        Handle_XCHG_acc_AX_AX(insb, cseip);
        break;

    case I_XCHG_acc_BP_AX:
        Handle_XCHG_acc_BP_AX(insb, cseip);
        break;

    case I_XCHG_acc_BX_AX:
        Handle_XCHG_acc_BX_AX(insb, cseip);
        break;

    case I_XCHG_acc_CX_AX:
        Handle_XCHG_acc_CX_AX(insb, cseip);
        break;

    case I_XCHG_acc_DI_AX:
        Handle_XCHG_acc_DI_AX(insb, cseip);
        break;

    case I_XCHG_acc_DX_AX:
        Handle_XCHG_acc_DX_AX(insb, cseip);
        break;

    case I_XCHG_acc_SI_AX:
        Handle_XCHG_acc_SI_AX(insb, cseip);
        break;

    case I_XCHG_acc_SP_AX:
        Handle_XCHG_acc_SP_AX(insb, cseip);
        break;
    ...
    case I_XOR_acc_AX_Ivds:
        Handle_XOR_acc_AX_Ivds(insb, cseip);
        break;
