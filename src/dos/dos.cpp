...
static Bitu DOS_21Handler(void) {
	...
	case 0x0b:		/* Get STDIN Status */
		if (!DOS_GetSTDINStatus()) { reg_al = 0x00; } else { reg_al = 0xFF; }
...
//Sure let's reset a virtual disk
	...
	case 0x2d:		/* Set System Time */
		...
		if (reg_ch > 23 || reg_cl > 59 || reg_dh > 59 || reg_dl > 99)
			...
			if (reg_cx == 0 && reg_dx == 0) { time_start = mem_readd(BIOS_TIMER); LOG_MSG("Warning: game messes with DOS time!"); } else time_start = 0;
			reg_al = 0;
		}
		break;
